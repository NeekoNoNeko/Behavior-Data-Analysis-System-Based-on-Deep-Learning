...
CLS_MODEL  = r'C:\workspace\Behavior-Data-Analysis-System-Based-on-Deep-Learning\ResNet\best_model.pth'  # YOLO-CLS 权重
...
def load_resnet_model(model_path):
    model = models.resnet50(num_classes=len(CLS_NAMES))  # 或根据你的模型结构修改
